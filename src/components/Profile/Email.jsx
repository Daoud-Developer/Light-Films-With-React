...
const Email = ({ setIsShowPromptReAuthFor, isUpdatingEmail, setIsUpdatingEmail, emailValueRef, }) => {
    ...
    return (<>
      ...
      <div>
        ...
        {!isUpdatingEmail && (<div className="flex justify-between mt-1">
        ...
        onSubmit={(e) => {
              ...
              <input type="email" ref={emailValueRef} defaultValue={currentUser?.email || ""} autoFocus onKeyDown={(e) => {
                if (e.key === "Escape")
