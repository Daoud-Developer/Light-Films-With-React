...
const DeleteAccount = ({ setIsShowPromptReAuthFor, }) => {
    ...
    return (<>
      ...
      <div className="flex justify-center mt-12 mb-6">
        <button onClick={() => setIsShowPrompt(true)} className="px-5 py-2  border rounded-full text-red-500 border-dark-lighten-2 bg-dark-lighten hover:bg-red-500 hover:text-white transition duration-300">
          Delete account
        </button>
      </div>
    </>);
