...
const ModalNotification = ({ type, message, setError, }) => {
    ...
    return (<>
      <div style={{
        ...
        <button onClick={() => {
            ...
            : "bg-red-500 shadow-red-500 hover:bg-red-600"} px-4 py-2 rounded-md shadow-md text-white mt-5 absolute left-1/2 -translate-x-1/2  transition duration-300 flex gap-2 items-center`}>
