...
const Explore = () => {
    ...
    return (<>
      ...
      {isShowScrollUpBtn && (<button onClick={scrollToTop} className={`fixed bottom-[30px] right-[30px] z-10 transition duration-500 ${isShowScrollUpBtn ? "opacity-100" : "opacity-0"}`}>
      ...
      <div className="flex flex-col-reverse md:flex-row">
        ...
        {isMobile && (<h2 className="text-white text-3xl font-medium uppercase ml-3 mt-3">
            Find films that best fit you
          </h2>)}
      </div>
    </>);
