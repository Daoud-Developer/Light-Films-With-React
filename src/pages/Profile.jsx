    ...
    return (<>
      ...
      {isShowPromptReAuthFor && (<>
          <form onSubmit={(e) => {
            ...
            <input ref={oldPasswordValueRef} type="password" autoFocus className="bg-dark-lighten-2 py-3 mt-3 rounded-md  outline-none px-5 text-white mb-4 w-full" placeholder="Type your password..."/>
          ...
          <div onClick={() => setIsShowPromptReAuthFor(undefined)} className="fixed top-0 left-0 w-full h-full z-[5] bg-black/60"></div>
        </>)}
          ...
          <div className="flex flex-col-reverse md:flex-row gap-8 md:gap-0 ">
            <div className="flex-grow">
              ...
              <div className="mt-7 max-w-[600px] w-full flex flex-col gap-3">
                <Email setIsShowPromptReAuthFor={setIsShowPromptReAuthFor} isUpdatingEmail={isUpdatingEmail} setIsUpdatingEmail={setIsUpdatingEmail} emailValueRef={emailValueRef}/>
                <Name setIsUpdating={setIsUpdating}/>
              </div>

              <EmailVerification setIsUpdating={setIsUpdating}/>

              <Password setIsShowPromptReAuthFor={setIsShowPromptReAuthFor} isUpdatedPassword={isUpdatedPassword} setIsUpdatedPassword={setIsUpdatedPassword} newPasswordValueRef={newPasswordValueRef}/>
