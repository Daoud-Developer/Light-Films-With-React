...
const Error = () => {
    ...
    return (<>
      {!isMobile && (<video autoPlay muted loop id="myVideo" className="fixed top-0 left-0 min-h-screen min-w-full -z-10 object-cover">
      ...
      <div className="md:bg-black/60 bg-dark min-h-screen tw-flex-center">
        <div>
          ...
          <div className="flex justify-center">
            <Link to="/" className="px-8 py-2 bg-primary rounded-md text-white text-xl mt-8 inline-block hover:bg-blue-600 transition duration-300">
              Go to Homepage
            </Link>
          </div>
        </div>
